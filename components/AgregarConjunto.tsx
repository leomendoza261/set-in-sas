        ...
        {form.subconjuntos.map((sub, index) => (
          <div key={index} className="grid grid-cols-3 gap-2 mb-2 ">
            <div>
              ...
              />
              <label htmlFor="ID subconponente" className='text-gray-500 text-xs'>ID subconponente</label>
            </div>
            <div>
              <input
                type="number"
            ...
            <Button type="button" onClick={() => eliminarSubconjunto(index)} className="bg-red-500 text-white px-2 rounded hover:bg-red-600"><CircleX className="h-3.5 w-3.5" /><span className="sr-only sm:not-sr-only sm:whitespace-nowrap"> Eliminar subcomponente</span></Button>
          </div>
        ))}
        <Button type="button" onClick={agregarSubconjunto} className="text-white text-sm">
          <PlusCircle className="h-3.5 w-3.5" />
          <span className="sr-only sm:not-sr-only sm:whitespace-nowrap"> Agregar subcomponente</span>
        </Button>
      </div>
